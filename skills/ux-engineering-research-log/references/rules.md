# ux-engineering-research-log — full rules and citations
...
## [S1] Axis: control-selection-by-field-type -> `playbook/control-selection.md`
...
## [S2] Axis: layout-grouping -> `playbook/layout-grouping.md`
...
## [S3] Axis: background-vs-edit-surface-contrast -> `playbook/surface-contrast.md`
...
## [S4] Axis: nav-order-vs-usage-frequency -> `playbook/navigation-depth.md`
...
## [S5] Axis: color-combination-visibility -> `playbook/color-visibility.md`
...
## [S6] Sources fetched but not used as a rule citation
...
## [S7] Removal-rule coverage check
