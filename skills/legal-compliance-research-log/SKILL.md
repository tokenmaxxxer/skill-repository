...
description: Use when you need guidance on Playbook research log — legal-compliance (issue #1174).
---
...
## Axis: lawful-basis-selection -> `playbook/lawful-basis-selection.md`
...
## Axis: retention-and-minimization -> `playbook/retention-minimization.md`
...
## Axis: cross-border-transfer-mechanism -> `playbook/cross-border-transfer.md`
...
## Axis: consent-mechanism-ux -> `playbook/consent-ux.md`
...
## Axis: vendor-dpa-requirements -> `playbook/vendor-dpa.md`
...
## Axis: oss-license-compatibility -> `playbook/license-compatibility.md`
...
## Removal-rule coverage check (amendment 4)
